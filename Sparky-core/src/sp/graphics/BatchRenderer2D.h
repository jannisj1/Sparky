...
#define RENDERER_MAX_TEXTURES	32 - 1
	...
	public:
		...
		void DrawRect(float x, float y, float width, float height, uint color = 0xffffffff, float thickness = 0.02f) override;
		void DrawRect(const maths::vec2& position, const maths::vec2& size, uint color = 0xffffffff, float thickness = 0.02f) override;
		void DrawRect(const maths::Rectangle& rectangle, uint color = 0xffffffff, float thickness = 0.02f) override;
